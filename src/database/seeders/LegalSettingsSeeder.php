...
final class LegalSettingsSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        $settings = [
            ...
            'legal_privacy_content' => $this->getPrivacyContent(),
            'legal_notice_published' => '1',
            'legal_notice_content' => $this->getNoticeContent(),
            'legal_cookies_published' => '1',
            'legal_cookies_content' => $this->getCookiesContent(),
            'legal_terms_published' => '1',
            'legal_terms_content' => $this->getTermsContent(),
        ];
...
HTML;
    ...
    private function getNoticeContent(): string
    {
        return <<<'HTML'
