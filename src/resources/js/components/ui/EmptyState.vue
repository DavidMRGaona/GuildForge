...
<template>
    <div
        class="rounded-lg bg-white p-12 text-center shadow dark:bg-stone-800 dark:shadow-stone-900/50"
    >
        <svg
        ...
        <p v-if="props.description" class="mt-2 text-sm text-stone-500 dark:text-stone-400">
            {{ props.description }}
        </p>
