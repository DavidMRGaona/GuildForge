                ...
                <div class="flex flex-wrap justify-center gap-6">
                    ...
                    >
                        <div class="flex items-start gap-4">
                            <div class="flex-shrink-0 rounded-lg bg-amber-100 dark:bg-amber-900/40 p-3 text-amber-600 dark:text-amber-400">
                                <svg
                                    class="h-6 w-6"
                                    fill="currentColor"
                                    viewBox="0 0 24 24"
                    ...
                    <BaseCard class="h-full">
                        <div class="h-full flex flex-col justify-center space-y-6">
                            ...
                            <div v-if="contactEmail" class="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 class="font-semibold text-stone-900 dark:text-stone-100">{{ t('about.contact.email') }}</h3>
                                    <a :href="'mailto:' + contactEmail" class="text-amber-600 hover:text-amber-500 dark:text-amber-400 dark:hover:text-amber-300 underline">
                                        {{ contactEmail }}
                                    </a>
                                </div>
                            </div>
                            ...
                            <div v-if="contactPhone" class="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 class="font-semibold text-stone-900 dark:text-stone-100">{{ t('about.contact.phone') }}</h3>
                                    <a :href="'tel:' + contactPhone" class="text-amber-600 hover:text-amber-500 dark:text-amber-400 dark:hover:text-amber-300 underline">
                                        {{ contactPhone }}
                                    </a>
                                </div>
                            </div>
                            ...
                            <div v-if="contactAddress" class="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 class="font-semibold text-stone-900 dark:text-stone-100">{{ t('about.contact.address') }}</h3>
                                    <p class="text-stone-600 dark:text-stone-400">{{ contactAddress }}</p>
                                </div>
                            </div>

                            <!-- Social Media Links -->
                            <div v-if="hasSocialLinks" class="pt-4 border-t border-stone-200 dark:border-stone-700">
                                <h3 class="font-semibold text-stone-900 dark:text-stone-100 mb-4">{{ t('about.contact.social.title') }}</h3>
                                <div class="flex gap-4">
                                    <a v-if="socialLinks.facebook" :href="socialLinks.facebook" target="_blank" rel="noopener noreferrer" class="rounded-lg bg-stone-100 dark:bg-stone-700 p-3 text-stone-600 dark:text-stone-400 hover:bg-amber-100 dark:hover:bg-amber-900/40 hover:text-amber-600 dark:hover:text-amber-400 transition-colors" aria-label="Facebook">
                                        <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                                    </a>
                                    <a v-if="socialLinks.instagram" :href="socialLinks.instagram" target="_blank" rel="noopener noreferrer" class="rounded-lg bg-stone-100 dark:bg-stone-700 p-3 text-stone-600 dark:text-stone-400 hover:bg-amber-100 dark:hover:bg-amber-900/40 hover:text-amber-600 dark:hover:text-amber-400 transition-colors" aria-label="Instagram">
                                    ...
                                    <a v-if="socialLinks.twitter" :href="socialLinks.twitter" target="_blank" rel="noopener noreferrer" class="rounded-lg bg-stone-100 dark:bg-stone-700 p-3 text-stone-600 dark:text-stone-400 hover:bg-amber-100 dark:hover:bg-amber-900/40 hover:text-amber-600 dark:hover:text-amber-400 transition-colors" aria-label="X (Twitter)">
                                    ...
                                    <a v-if="socialLinks.discord" :href="socialLinks.discord" target="_blank" rel="noopener noreferrer" class="rounded-lg bg-stone-100 dark:bg-stone-700 p-3 text-stone-600 dark:text-stone-400 hover:bg-amber-100 dark:hover:bg-amber-900/40 hover:text-amber-600 dark:hover:text-amber-400 transition-colors" aria-label="Discord">
                                    ...
                                    <a v-if="socialLinks.tiktok" :href="socialLinks.tiktok" target="_blank" rel="noopener noreferrer" class="rounded-lg bg-stone-100 dark:bg-stone-700 p-3 text-stone-600 dark:text-stone-400 hover:bg-amber-100 dark:hover:bg-amber-900/40 hover:text-amber-600 dark:hover:text-amber-400 transition-colors" aria-label="TikTok">
