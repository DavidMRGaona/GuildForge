...
final class ModuleMakeVueComponentCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'module:make-vue-component
     ...
     * @var string
     */
    protected $description = 'Create a new Vue component for a module';
    ...
    public function handle(): int
    {
        ...
        $this->info("Creating Vue component '{$name}' for module '{$module}'...");

        $result = $this->scaffoldingService->createVueComponent($module, $name);
