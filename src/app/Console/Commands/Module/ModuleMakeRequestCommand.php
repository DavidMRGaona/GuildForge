...
final class ModuleMakeRequestCommand extends Command
{
    /**
    ...
    public function handle(): int
    {
        ...
        $this->info("Creating request '{$name}' for module '{$module}'...");

        $result = $this->scaffoldingService->createRequest($module, $name);
