...
final class ModuleMakeVuePageCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'module:make-vue-page
     ...
     * @var string
     */
    protected $description = 'Create a new Vue page for a module';
    ...
    public function handle(): int
    {
        ...
        $this->info("Creating Vue page '{$name}' for module '{$module}'...");

        $result = $this->scaffoldingService->createVuePage($module, $name);
