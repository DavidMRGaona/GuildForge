...
final class ModuleMakeNotificationCommand extends Command
{
    /**
    ...
    public function handle(): int
    {
        ...
        $this->info("Creating notification '{$name}' for module '{$module}'...");

        $result = $this->scaffoldingService->createNotification($module, $name);
