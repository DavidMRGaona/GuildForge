 ...
 * @method static string route(string $name, array<string, mixed> $parameters = [])
 * @method static string trans(string $key, array<string, string> $replace = [])
 * @method static View view(string $name, array<string, mixed> $data = [])
 * @method static bool isEnabled(string $moduleName)
 * @method static array<string> getEnabled()
