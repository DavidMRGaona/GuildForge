...
return [
    ...
    'filament' => [
        ...
        'confirm' => [
            ...
            'delete_data_label' => 'Also delete module data',
            'delete_data_help' => 'If checked, the tables and data created by the module will be deleted. If unchecked, the data will be preserved in case you want to reinstall the module in the future.',
        ],
        'empty' => [
            'title' => 'No modules',
