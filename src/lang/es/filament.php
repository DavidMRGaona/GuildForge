...
return [
    ...
    'dashboard_settings' => [
        ...
        'saved' => 'Configuración del panel guardada correctamente',
        'reset' => 'Configuración restablecida a valores por defecto',
        'reset_button' => 'Restablecer por defecto',
        'reset_confirm_title' => 'Restablecer configuración',
        'reset_confirm_description' => 'Se restablecerá la configuración del panel a los valores por defecto. Esta acción no se puede deshacer.',
        'fields' => [
            'widget' => 'Widget',
            'enabled' => 'Activo',
            'sort' => 'Orden',
            'limit' => 'Filas',
            'limit_help' => 'Número de filas a mostrar en la tabla',
        ],
        'widgets' => [
            'upcoming_events_widget' => 'Próximos eventos',
            'recent_articles_widget' => 'Artículos recientes',
            'gallery_stats_widget' => 'Estadísticas de galería',
            'mail_health_widget' => 'Estado del correo',
            'mail_stats_overview_widget' => 'Estadísticas de correo',
            'today_bookings_widget' => 'Reservas de hoy',
            'upcoming_bookings_widget' => 'Próximas reservas',
            'membership_stats_widget' => 'Estadísticas de socios',
            'expiring_memberships_widget' => 'Membresías por vencer',
            'overdue_fees_widget' => 'Cuotas vencidas',
            'pending_moderation_widget' => 'Mesas pendientes de moderación',
            'registration_stats_widget' => 'Estadísticas de inscripciones',
            'consent_stats_widget' => 'Estadísticas de consentimiento',
        ],
    ],
];
